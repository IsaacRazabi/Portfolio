      ...
      />
         <!-- <ul class="img-content">
          ...
          <span class="img-content">
              <p v-for="(tech, idx) in project.Tecnolegies"
              :key="idx"
              class="cover-tech-txt ">    {{ tech }}</p>
              </span>
    </span>

    <main ref="modalWrapper" v-if="isActive" :class="{ modalWrapper: isActive }">
        ...
        <h1 class="head-line">{{ project.title }}</h1>
          ...
          <div class="links">
            <p>
              ...
              >
              <span><button class="link-btn">  <a :href="getWebLink"> View the Website</a></button></span> 
            </p>
          </div>
          <div class="video">
              <!-- <el-table
